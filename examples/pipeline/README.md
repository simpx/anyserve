...
- Worker A (tokenize) on port 50051
- Worker B (analyze) on port 50052
- Worker C (format) on port 50053
...
Press `Ctrl+C` in the terminal running `run.sh` to stop all services.
