"""
KServe gRPC Client for AnyServe
...
class KServeClient:
    ...
    def _ensure_connected(self):
        ...
        if self._channel is None:
            ...
            # Import proto stubs
            # Try to import from installed anyserve package first
            try:
                ...
                # Try local proto directory
                proto_path = os.path.join(os.path.dirname(__file__), '..', 'python', 'anyserve', '_proto')
